export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxee0fd3985fe63c7b",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "2997290dd3614bafcba64537dcebb893",
  ...
  USERS: [
    {
      ...
      id: "ouoMX6FCVBdMUPeG_v6eQ46dfdO4",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "fGAnJIpOdYt-WRuFuoJcNga9eW9_SZx7NR2TgH0Sc4c",
      // 所在省份
      province: "湖南",
      // 所在城市
      city: "长沙",
